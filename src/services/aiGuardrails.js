...
function buildSystemPrompt() {
  return [
    ...
    '3.b. NUNCA incluyes identificadores numericos (idpoha, idplanta, iddolencia) en',
    '   el campo "respuesta". Los IDs viajan por idpoha_refs; el texto visible solo',
    '   menciona plantas por su nombre comun/cientifico.',
